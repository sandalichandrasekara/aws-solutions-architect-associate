...
A **self-paced study repository** for anyone preparing for the AWS Certified
Solutions Architect - Associate exam (SAA-C03).

![AWS SAA-C03](aws-saa-c03.png)
...
- **Cost:** 150 USD (check current pricing)
...
> Weights and exam details can change. Always confirm against the official AWS exam guide.
